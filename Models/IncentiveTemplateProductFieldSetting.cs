...
public partial class IncentiveTemplateProductFieldSetting
{
    public long IncentiveTemplateProductFieldSettingId { get; set; }

    public long OrganisationId { get; set; }

    public int IncentiveTemplateProductFieldCategoryId { get; set; }
    ...
    public virtual FieldCategory IncentiveTemplateProductFieldCategory { get; set; } = null!;
